...
template<class data_T, class res_T, typename CONFIG_T>
  void gru_stack_single(
      ...
      hls::stream<data_T> initial_state[1],
...
template<class data_T, class res_T, typename CONFIG_T>
  void gru_stack_array(
      ...
      hls::stream<data_T> initial_state[CONFIG_T::n_state],
...
template<class data_T, class res_T, typename CONFIG_T>
  void gru_stack_switch(
      hls::stream<data_T> data_stream[CONFIG_T::data_transfer_in],
      hls::stream<data_T> initial_state[CONFIG_T::data_transfer_in_init],
      hls::stream<res_T>  res_stream[CONFIG_T::data_transfer_out],
      typename CONFIG_T::weight_t     param   [CONFIG_T::n_state*3*CONFIG_T::n_in],
      typename CONFIG_T::weight_t     param_zr[CONFIG_T::n_state*3*CONFIG_T::n_state],
      typename CONFIG_T::bias_t       param_b [CONFIG_T::n_state*3],
      typename CONFIG_T::bias_t       param_br [CONFIG_T::n_state*3]
    ...
    if(CONFIG_T::data_transfer_in == 1 && CONFIG_T::data_transfer_out == 1){
        gru_stack_single<data_T, res_T, CONFIG_T>(data_stream, initial_state, res_stream, param, param_zr, param_b, param_br);
    }else {
        gru_stack_array<data_T, res_T, CONFIG_T>(data_stream, initial_state, res_stream, param, param_zr, param_b, param_br);
    }
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<class data_T, class res_T, typename CONFIG_T>
