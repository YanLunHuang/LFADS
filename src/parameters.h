...
struct config2_1 : nnet::dense_config {
    ...
    static const unsigned n_zeros = 178;
    static const unsigned n_nonzeros = 13262;
...
struct config2_2 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 12116;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef accum_dense2_t accum_t;
    typedef forward_bias2_t bias_t;
...
struct config4 : nnet::dense_config {
    ...
    static const unsigned n_zeros = 765;
    static const unsigned n_nonzeros = 7427;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config10_1 : nnet::dense_config {
    ...
    static const unsigned n_zeros = 573;
    static const unsigned n_nonzeros = 11715;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config10_2 : nnet::dense_config {
    ...
    static const unsigned n_zeros = 5768;
    static const unsigned n_nonzeros = 6520;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef accum_dense10_t accum_t;
    typedef bias10_t bias_t;
...
struct config17_mult : nnet::dense_config {
    ...
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef dense_mean_accum_t accum_t;
