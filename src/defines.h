...
typedef ap_fixed<31,12> accum2_t;
typedef ap_fixed<8,2> forward_weight2_t;
typedef ap_fixed<8,2> backward_weight2_t;
typedef ap_fixed<8,2> forward_recurrent_weight2_t;
typedef ap_fixed<8,2> backward_recurrent_weight2_t;
typedef ap_fixed<8,2> forward_bias2_t;
typedef ap_fixed<8,2> forward_recurrent_bias2_t;
typedef ap_fixed<8,2> backward_bias2_t;
typedef ap_fixed<8,2> backward_recurrent_bias2_t;
...
typedef ap_fixed<23,12> accum_dense2_t;
...
typedef ap_fixed<30,11> accum10_t;
typedef ap_fixed<8,2> weight10_t;
typedef ap_fixed<8,2> recurrent_weight10_t;
typedef ap_fixed<8,2> bias10_t;
typedef ap_fixed<8,2> recurrent_bias10_t;
typedef ap_fixed<8,1,AP_RND_CONV,AP_SAT> act10_t;
typedef ap_ufixed<8,0,AP_RND_CONV,AP_SAT> recr_act10_t;
typedef ap_fixed<8,3,AP_RND_CONV,AP_SAT> state10_t;
typedef ap_ufixed<2,0> slope10_t;
typedef ap_ufixed<2,0> shift10_t;
typedef ap_fixed<19,6> layer10_t;
typedef ap_fixed<22,11> accum_dense10_t;
...
typedef ap_fixed<8,3,AP_RND_CONV,AP_SAT> layer14_t;
typedef ap_fixed<18,8> q_act_postdense_table_t;
typedef ap_fixed<16,6> result_t;
typedef ap_fixed<8,2> neuraldense_weight_t;
typedef ap_fixed<8,2> neuraldense_bias_t;
typedef ap_fixed<18,6> dense_mean_accum_t;
