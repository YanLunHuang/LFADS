...
void myproject(
    ...
    nnet::linear<layer4_t, layer8_t, linear_config8>(layer4_out, layer8_out); // q_activation_30 dense_mean
    ...
    nnet::linear<layer6_t, layer9_t, linear_config9>(layer6_out, layer9_out); // q_activation_32 dense_logvar
    ...
    nnet::explogvar<layer9_t, layer10_t, config10>(layer9_out, layer10_out); // exponent_logvar_5
	 ...
	 nnet::srn<layer29_t, layer11_t, config11>(layer29_cpy1, layer11_out, state); // standard_random_normal_5
    ...
    //nnet::sample<layer8_t, layer9_t, layer16_t>(layer8_out , layer9_out, layer16_out, normal);
