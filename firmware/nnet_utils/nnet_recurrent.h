...
template<class data_T, class res_T, typename CONFIG_T>
  void gru_stack_switch(
    ...
    if(CONFIG_T::data_transfer_in == 1 && CONFIG_T::data_transfer_out == 1){
        gru_stack_single<data_T, res_T, CONFIG_T>(data_stream, res_stream, param, param_zr, param_b, param_br);
    }else {
        gru_stack_array<data_T, res_T, CONFIG_T>(data_stream, res_stream, param, param_zr, param_b, param_br);
    }
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
